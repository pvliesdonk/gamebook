...
- a **web wiki** — connected, searchable, cross-linked (HTML);
...
**UI kits** (`ui_kits/`)
- *wiki/* — the HTML wiki: Gazetteer browse + full Article reading view (interactive).
- *print/* — the Typst/PDF bound spread (typographic specimen).
